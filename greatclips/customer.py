...
from greatclips.api import stylewaretouch_api
...
def customer_check_in(store, name, phone, guests, ip, profile_id, output_json):
    ...
    """
    try:
        result = stylewaretouch_api.check_in_customer(
            store_number=store,
            name=name,
            phone=phone,
            guests=guests,
...
def customer_cancel(oci_id, store, phone, guests, ip, name, output_json):
    ...
    """
    try:
        result = stylewaretouch_api.cancel_check_in(
            oci_id=oci_id,
            store_number=store,
            phone=phone,
            guests=guests,
...
def customer_status(oci_id, store, phone, guests, ip, profile_id, name, output_json):
    ...
    """
    try:
        result = stylewaretouch_api.get_customer_status(
            oci_id=oci_id,
            store_number=store,
            phone=phone,
            guests=guests,
